...
public class CreateUser_StepDefs {
    ...
    public void navigate_to_user_module() { booksPage.usersModule.click(); }
    ...
    public void the_message_should_be_displayed(String string) { Assert.assertTrue(userPage.message.isDisplayed()); }
    ...
    @Then("verify editing")
    public void verify_editing() { Assert.assertTrue(userPage.message.isDisplayed()); }
